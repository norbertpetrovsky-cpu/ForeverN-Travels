...
export default function Trip() {
  ...
  // Module navigation — built modules route directly, others show coming soon
  const BUILT_MODULES = ['balenie', 'plan']

  function handleModuleClick(modId) {
    if (BUILT_MODULES.includes(modId)) {
      navigate(`/trip/${id}/${modId}`)
    } else {
